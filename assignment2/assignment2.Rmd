...
summary(coupsglm)
```
Since pollib has 3 levels, we treat this variable as a factor. From the result, we can see variables: oligarchy, 


pollib2 and parties have p value < 0.05 which means they are significant and have effect on miltcoup. All other variables have p values > 0.05, which means they are insignificant and have no effect on miltcoup. Furthermore, all together the variables have 
